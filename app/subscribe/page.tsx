...
export default function SubscribePage() {
  return (
    <main className="mx-auto max-w-xl px-4 py-16">
      <h1 className="text-2xl font-bold text-neutral-900">The Cross-Border Brief</h1>
      ...
      <p className="mt-3 text-xs text-neutral-400">Double opt-in. Unsubscribe anytime.</p>
    </main>
  );
}
