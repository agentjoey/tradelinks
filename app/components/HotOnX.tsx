        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {topics.map((x, i) => (
            <TrackedLink
              ...
              className="group rounded-lg border border-line border-l-2 border-l-calm bg-surface/60 p-4 transition-colors hover:bg-surface2"
            >
              ...
              <div className="font-display text-[16px] font-medium leading-snug text-ink transition-colors group-hover:text-calm">{x.headline}</div>
